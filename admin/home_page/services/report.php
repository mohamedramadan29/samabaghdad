            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn btn-primary waves-effect btn-sm" data-toggle="modal" data-target="#add-Modal"> اضافة خدمة <i class="fa fa-plus"></i> </button>
                    </div>
                    <?php
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="my_table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $connect->prepare("SELECT * FROM services ORDER BY id DESC");
                                    $stmt->execute();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> <img width="80px" height="80px" class="product-img img-bordered" src="home_page/services/uploads/<?php echo  $record['image']; ?>" alt=""> </td>
                                            <td>
                                                ...
                                                <a href="main.php?dir=home_page/services&page=delete&request_id=<?php echo $record['id']; ?>" class="confirm btn btn-danger btn-sm"> حذف <i class='fa fa-trash'></i> </a>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit-Modal_<?php echo $record['id']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" action="main.php?dir=home_page/services&page=edit" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="add-Modal" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="main.php?dir=home_page/services&page=add" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="name"> العنوان </label>
