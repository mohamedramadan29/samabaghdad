        ...
        <div class="container">
            ...
            if (isset($_POST['send_request'])) {
                try {
                    ...
                    if (empty($formerror)) {
                        $stmt = $connect->prepare("INSERT INTO western (order_number,phone,sender_name,reciever_name,country_area_sender,country_area_reciever,email,amount,transfer_method,created_at)
                        VALUES(:zorder_number,:zphone,:zsender_name,:zreciever_name,:zcountry_area_sender,:zcountry_area_reciever,:zemail,:zamount,:ztransfer_method,:zcreated_at)
                        ");
                        $stmt->execute(array(
