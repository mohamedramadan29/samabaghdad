                ...
                switch ($step) {
                    case 1:
                        ...
                        <form action="dollar?step=2" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box">
                                <input type="checkbox" id="confirm_checked" name="dollar_confirm_checked"
                                       value="1" <?php echo (isset($_SESSION['dollar_confirm_checked']) && $_SESSION['dollar_confirm_checked'] == 1) ? 'checked' : ''; ?>
                                       required>
                            ...
                            <div class="paginate_buttons d-flex justify-content-end">
                                <button class="btn btn-warning" type="submit"> التالي <i class="fa fa-arrow-left"></i>
                                </button>
                            </div>
                        </form>
                        <?php
                    ...
                    case 2:
                        ...
                        <form method="post" action="upload_dollar" enctype="multipart/form-data" id="uploadForm">
                            ...
                            <div class="box">
                                <label for="allah"> هل انت من حجاج بيت الله <span style="color: red;"> * </span>
                                </label>
                                <select name="allah" id="allah" class="form-control">
                                    <option value="نعم انا من الحجاج" <?php echo (isset($_SESSION['allah']) && $_SESSION['allah'] == 'نعم انا من الحجاج') ? 'selected' : ''; ?>>
                                        نعم انا من الحجاج
                                    </option>
                                    <option value="لا انا لست حاج" <?php echo (isset($_SESSION['allah']) && $_SESSION['allah'] == 'لا انا لست حاج') ? 'selected' : ''; ?>>
                                        لا انا لست حاج
                                    </option>
                                </select>
                            </div>
                            <div class="box">
                                ...
                                <select name="port_type" id="port_type" class="form-control">
                                    <option value="سفر بري" <?php echo (isset($_SESSION['port_type']) && $_SESSION['port_type'] == 'سفر بري') ? 'selected' : ''; ?>>
                                        سفر بري
                                    </option>
                                    <option value="سفر جوي" <?php echo (isset($_SESSION['port_type']) && $_SESSION['port_type'] == 'سفر جوي') ? 'selected' : ''; ?>>
                                        سفر جوي
                                    </option>
                                </select>
                            </div>
                            <div class="box">
                                <label for="where_receieve_dollar"> من اين تريد استلام الدولار <span
                            ...
                            <div class="box">
                                ...
                                <input type="text" name="dollar_phone" required class="form-control"
                                       value="<?php echo isset($_SESSION['dollar_phone']) ? $_SESSION['dollar_phone'] : ''; ?>">
                            </div>
                            <div class="box">
                                <label for="dollar_name"> الاسم <span style="color: red;"> * </span> </label>
                                <input type="text" name="dollar_name" required class="form-control"
                                       value="<?php echo isset($_SESSION['dollar_name']) ? $_SESSION['dollar_name'] : ''; ?>">
                            </div>
                            <div class="box">
                                ...
                                <input type="date" name="travel_date" required class="form-control"
                                       value="<?php echo isset($_SESSION['travel_date']) ? $_SESSION['travel_date'] : ''; ?>">
                            </div>
                            <div class="box">
                                <label for="travel_to"> بلد الوجهة <span style="color: red;"> * </span> </label>
                                <input type="text" name="travel_to" required class="form-control"
                                       value="<?php echo isset($_SESSION['travel_to']) ? $_SESSION['travel_to'] : ''; ?>">
                            </div>
                            <div class="box">
                            ...
                            <div class="box">
                                <label for="passport_image"> ارفاق صورة جواز السفر <span style="color: red;"> * </span>
                                </label>
                                <input type="file" required name="passport_image" class="form-control"
                                       id="passport_image">
                            </div>
                            <div class="box">
                                <label for="ticket_image"> ارفاق صورة تذكرة السفر <span style="color: red;"> * </span>
                                </label>
                            ...
                            <div class="box">
                                ...
                                <div>
                                    <button id="capture" class="btn btn-primary btn-sm">   التقاط <i class="fa fa-camera"></i>  </button>
                                    <br>
                                    <img id="preview" src="" alt=" التقط صورة لعرضها هنا  ">
                                   <br>
                                    <button id="retake" style="display: none;" class="btn btn-danger btn-sm">حذف و إعادة
                            ...
                            <div class="paginate_buttons d-flex justify-content-end">
                                <button class="btn btn-danger" type="submit" name="previous" formaction="dollar?step=1">
                                    الرجوع الي الخلف
                                </button>
                                <button style="margin: 0 10px;" class="btn btn-primary" name="send_dollar_request"
                                        type="submit">ارسال
                                </button>
                            </div>
                        </form>
