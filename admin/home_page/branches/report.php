        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item active"> فروع الشركة </li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn btn-primary waves-effect btn-sm" data-toggle="modal" data-target="#add-Modal"> اضافة فرع جديد <i class="fa fa-plus"></i> </button>
                    </div>
                    <?php
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="my_table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $connect->prepare("SELECT * FROM branches ORDER BY id DESC");
                                    $stmt->execute();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="main.php?dir=home_page/branches&page=delete&request_id=<?php echo $record['id']; ?>" class="confirm btn btn-danger btn-sm"> حذف <i class='fa fa-trash'></i> </a>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit-Modal_<?php echo $record['id']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" action="main.php?dir=home_page/branches&page=edit" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="add-Modal" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"> أضافة فرع  </h4>
                            </div>
                            <form action="main.php?dir=home_page/branches&page=add" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="form-group">
